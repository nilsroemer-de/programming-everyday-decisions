...
## [Casino]{.invert-font} {background-image="../images/bg/lec05-casino.jpg"}
::: footer
:::

## [Lottery]{.invert-font} {background-image="../images/bg/lec05-lottery.jpg"}
::: footer
:::

## [Shuffling cards]{.invert-font} {background-image="../images/bg/lec05-cards.jpg"}
::: footer
:::

## [Algorithms]{.invert-font} {background-image="../images/bg/lec05-algorithms.jpg"}
::: footer
:::

## [Cryptography]{.invert-font} {background-image="../images/bg/lec05-crypto.jpg"}
::: footer
:::

## [Genetic mutations]{.invert-font} {background-image="../images/bg/lec05-mutations.jpg"}
::: footer
:::
