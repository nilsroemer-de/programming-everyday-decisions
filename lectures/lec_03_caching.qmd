...
![](../images/caching/lec03-caching-photo.jpg){width="60%"}
...
::: {style="text-align: center;"}
![](../images/caching/lec03-tradeoff.png){width="50%"}
...
[^4]: The main inspiration for this lecture. We have read it and discussed it in depth, always wanting to translate it into a course.
